...
$result = mysqli_query($conn,"SELECT * FROM `foods` where catagory_id = 7");
...
$result2 = mysqli_query($conn,"SELECT * FROM `foods` where catagory_id = 1");
...
$result3 = mysqli_query($conn,"SELECT * FROM `foods` where catagory_id = 2");
...
$result4 = mysqli_query($conn,"SELECT * FROM `foods` where catagory_id = 4");
...
$result5 = mysqli_query($conn,"SELECT * FROM `foods` where catagory_id = 5");
...
$result6 = mysqli_query($conn,"SELECT * FROM `foods` where catagory_id = 6");
